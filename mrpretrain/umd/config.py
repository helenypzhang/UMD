...
def task_pretrain_umd():
    ...
    datasets = ["medicat", "roco"]
    # loss_names = _loss_names({"itm": 1, "mlm": 1, "mim": 1, "itc": 1, "bb": 1, "feal": 1, "feai": 1})
    # loss_names = _loss_names({"itm": 1, "mlm": 1, "mim": 1, "feal": 1, "feai": 1, "itc": 1})
    loss_names = _loss_names({"itm": 1, "mlm": 1, "mim": 1, "feal": 1, "feai": 1})
    batch_size = 256
    max_epoch = 10
    max_steps = 100000
    warmup_steps = 0.1
    ...
    # only open for mrpretrain_layer
    # mim_layer = 3
